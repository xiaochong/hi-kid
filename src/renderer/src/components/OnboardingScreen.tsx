      ...
      <div className={styles.content}>
        ...
        <div className={styles.steps}>
          <div className={styles.step}>
            ...
            <span className={styles.stepText}>Press and hold the microphone button to talk to me</span>
          </div>
          <div className={styles.step}>
            <span className={styles.stepIcon}>2</span>
            <span className={styles.stepText}>Let go when you finish speaking, and I will reply</span>
          </div>
          <div className={styles.step}>
            <span className={styles.stepIcon}>3</span>
            <span className={styles.stepText}>You can also turn on subtitles to see our conversation</span>
          </div>
        </div>
