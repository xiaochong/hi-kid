...
const translations = {
  zh: {
    ...
    hero_subtitle:
      '专为非英语国家儿童设计的桌面应用，让练习英语口语变得像聊天一样轻松有趣。',
    hero_cta: '立即下载',
    hero_github: 'GitHub',
    ...
    feature1_desc:
      '不需要打字，直接对着麦克风说话，AI 就能听懂并回复你。',
    feature2_title: '隐私安全',
    feature2_desc:
      '对话、语音和模型全部在本地运行，不上传任何数据到云端。',
    feature3_title: '无需联网',
    feature3_desc:
      '录音、识别、合成和对话全部通过本地流水线完成，没有网络也能用。',
    feature4_title: '可爱界面',
    feature4_desc:
      '灵感来自《动物森友会》的卡通风格，孩子们一定会喜欢。',
    feature5_title: '聪明又耐心',
    feature5_desc:
      '聊什么都行，说得慢或说得简单都没关系，AI 会耐心地陪你练习。',
    feature6_title: '讲故事、玩游戏',
    feature6_desc:
      '不只是对话练习，还可以听故事、玩单词游戏，让学习不再枯燥。',
    ...
    step3_title: '一键启动',
    step3_desc:
      '第一次打开时，HiKid 会自动检测并下载所需依赖，无需手动配置。',
    install_note:
    ...
    config_custom_desc:
      '你也可以在应用设置中配置自己的 LLM 后端，支持任何兼容 OpenAI API 的服务。',
  ...
  en: {
    ...
    feature1_desc:
      'No typing needed — speak into the mic and the AI understands and replies.',
    ...
    feature4_desc:
      'Animal Crossing-inspired cartoon style that kids will love.',
    ...
    feature6_desc:
      'More than conversation practice — listen to stories and play word games.',
    ...
    step2_desc:
      'Open the dmg and drag HiKid into your Applications folder.',
    step3_title: 'Launch & Go',
    step3_desc:
      'On first launch HiKid auto-detects and downloads any missing dependencies.',
    install_note:
